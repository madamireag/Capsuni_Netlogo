...
<experiments>
  <experiment name="experiment" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [ power &gt;= val ]</metric>
    <enumeratedValueSet variable="sun">
      <value value="60"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number_of_strawberries">
      <value value="7500"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="rain">
      <value value="40"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
